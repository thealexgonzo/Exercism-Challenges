...
static class Appointment
{
    public static DateTime Schedule(string appointmentDateDescription) => 
        DateTime.TryParse(appointmentDateDescription, out DateTime date) ? date : DateTime.Now;
    ...
    public static DateTime AnniversaryDate() => new DateTime(DateTime.Now.Year, 09, 15);
}
